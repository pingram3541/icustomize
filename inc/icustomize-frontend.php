...
if ( ! defined( 'ABSPATH' ) ) {
     ...
     * --------------------------------------------------------------------------- */
    if ( ! function_exists('icustomize_get_css')) {
     ...
     * --------------------------------------------------------------------------- */
    if ( ! function_exists('icustomize_set_css')) {
     ...
     * --------------------------------------------------------------------------- */
    if ( ! function_exists('icustomize_get_js')) {
     ...
     * --------------------------------------------------------------------------- */
    if ( ! function_exists('icustomize_set_js')) {
    ...
    //future types, might be too much specificity
